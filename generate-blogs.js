...
function generateHTML(post) {
  ...
  const LOGO_SVG = `<div class="mavy-glass-tesseract logo-icon" style="width: 2.6em; height: 2.6em;">  <div class="tesseract-scene">    <div class="tesseract-cube">      <div class="cube-face cube-front"></div>      <div class="cube-face cube-back"></div>      <div class="cube-face cube-right"></div>      <div class="cube-face cube-left"></div>      <div class="cube-face cube-top"></div>      <div class="cube-face cube-bottom"></div>      <div class="cube-node node-1"></div>      <div class="cube-node node-2"></div>      <div class="cube-node node-3"></div>      <div class="cube-node node-4"></div>      <div class="cube-node node-5"></div>      <div class="cube-node node-6"></div>      <div class="cube-node node-7"></div>      <div class="cube-node node-8"></div>      <div class="cube-core">M</div>    </div>  </div></div>`;
