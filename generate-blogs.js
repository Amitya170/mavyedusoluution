...
function generateHTML(post) {
  ...
  const LOGO_SVG = `<div class="mavy-interlocking-me logo-icon" style="width: 2.6em; height: 2.6em;">  <div class="me-3d-tumbler">    <div class="me-layer layer-front"><svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" style="width:100%; height:100%; overflow:visible;">  <defs>    <linearGradient id="meGradM" x1="0%" y1="0%" x2="100%" y2="100%">      <stop offset="0%" stop-color="#FCD34D" />      <stop offset="50%" stop-color="#C084FC" />      <stop offset="100%" stop-color="#7E22CE" />    </linearGradient>    <linearGradient id="meGradE" x1="0%" y1="100%" x2="100%" y2="0%">      <stop offset="0%" stop-color="#22D3EE" />      <stop offset="50%" stop-color="#0284C7" />      <stop offset="100%" stop-color="#a855f7" />    </linearGradient>    <filter id="meGlow" x="-30%" y="-30%" width="160%" height="160%">      <feGaussianBlur stdDeviation="2.5" result="blur" />      <feMerge>        <feMergeNode in="blur" />        <feMergeNode in="SourceGraphic" />      </feMerge>    </filter>  </defs>  <!-- Outer Tech Orbit Ring -->  <circle cx="60" cy="60" r="54" stroke="url(#meGradE)" stroke-width="1.5" stroke-dasharray="12 6" opacity="0.6" class="me-orbit" />  <!-- 'E' Component (EduSolutions - Background Spine) -->  <path d="M 35 35 L 85 35 M 35 60 L 75 60 M 35 85 L 85 85 M 35 35 L 35 85" stroke="url(#meGradE)" stroke-width="6" stroke-linecap="round" stroke-linejoin="round" opacity="0.85" />  <!-- 'M' Component (Mavy - Interlocking Foreground) -->  <path d="M 25 85 L 25 35 L 60 68 L 95 35 L 95 85" stroke="url(#meGradM)" stroke-width="7" stroke-linecap="round" stroke-linejoin="round" filter="url(#meGlow)" />  <!-- AI Neural Nodes (Illuminated Data Points) -->  <circle cx="25" cy="35" r="4.5" fill="#ffffff" filter="url(#meGlow)" />  <circle cx="60" cy="68" r="4.5" fill="#FCD34D" filter="url(#meGlow)" />  <circle cx="95" cy="35" r="4.5" fill="#ffffff" filter="url(#meGlow)" />  <circle cx="35" cy="60" r="4" fill="#22D3EE" filter="url(#meGlow)" />  <circle cx="75" cy="60" r="4" fill="#FCD34D" filter="url(#meGlow)" />  <circle cx="85" cy="35" r="4" fill="#22D3EE" filter="url(#meGlow)" />  <circle cx="85" cy="85" r="4" fill="#22D3EE" filter="url(#meGlow)" /></svg></div>    <div class="me-layer layer-back"><svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" style="width:100%; height:100%; overflow:visible;">  <defs>    <linearGradient id="meGradM" x1="0%" y1="0%" x2="100%" y2="100%">      <stop offset="0%" stop-color="#FCD34D" />      <stop offset="50%" stop-color="#C084FC" />      <stop offset="100%" stop-color="#7E22CE" />    </linearGradient>    <linearGradient id="meGradE" x1="0%" y1="100%" x2="100%" y2="0%">      <stop offset="0%" stop-color="#22D3EE" />      <stop offset="50%" stop-color="#0284C7" />      <stop offset="100%" stop-color="#a855f7" />    </linearGradient>    <filter id="meGlow" x="-30%" y="-30%" width="160%" height="160%">      <feGaussianBlur stdDeviation="2.5" result="blur" />      <feMerge>        <feMergeNode in="blur" />        <feMergeNode in="SourceGraphic" />      </feMerge>    </filter>  </defs>  <!-- Outer Tech Orbit Ring -->  <circle cx="60" cy="60" r="54" stroke="url(#meGradE)" stroke-width="1.5" stroke-dasharray="12 6" opacity="0.6" class="me-orbit" />  <!-- 'E' Component (EduSolutions - Background Spine) -->  <path d="M 35 35 L 85 35 M 35 60 L 75 60 M 35 85 L 85 85 M 35 35 L 35 85" stroke="url(#meGradE)" stroke-width="6" stroke-linecap="round" stroke-linejoin="round" opacity="0.85" />  <!-- 'M' Component (Mavy - Interlocking Foreground) -->  <path d="M 25 85 L 25 35 L 60 68 L 95 35 L 95 85" stroke="url(#meGradM)" stroke-width="7" stroke-linecap="round" stroke-linejoin="round" filter="url(#meGlow)" />  <!-- AI Neural Nodes (Illuminated Data Points) -->  <circle cx="25" cy="35" r="4.5" fill="#ffffff" filter="url(#meGlow)" />  <circle cx="60" cy="68" r="4.5" fill="#FCD34D" filter="url(#meGlow)" />  <circle cx="95" cy="35" r="4.5" fill="#ffffff" filter="url(#meGlow)" />  <circle cx="35" cy="60" r="4" fill="#22D3EE" filter="url(#meGlow)" />  <circle cx="75" cy="60" r="4" fill="#FCD34D" filter="url(#meGlow)" />  <circle cx="85" cy="35" r="4" fill="#22D3EE" filter="url(#meGlow)" />  <circle cx="85" cy="85" r="4" fill="#22D3EE" filter="url(#meGlow)" /></svg></div>  </div></div>`;
