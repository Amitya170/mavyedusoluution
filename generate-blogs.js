...
function generateHTML(post) {
  ...
  const LOGO_SVG = '<svg class="logo-icon" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="globeGrad1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#a78bfa" /><stop offset="100%" stop-color="#6d28d9" /></linearGradient><linearGradient id="globeGrad2" x1="0%" y1="100%" x2="100%" y2="0%"><stop offset="0%" stop-color="#fbbf24" /><stop offset="100%" stop-color="#b45309" /></linearGradient></defs><rect width="100" height="100" rx="22" fill="#050510"/><circle cx="50" cy="50" r="28" stroke="url(#globeGrad1)" stroke-width="4"/><ellipse cx="50" cy="50" rx="28" ry="12" stroke="url(#globeGrad1)" stroke-width="3"/><ellipse cx="50" cy="50" rx="12" ry="28" stroke="url(#globeGrad1)" stroke-width="3"/><circle cx="50" cy="22" r="5" fill="url(#globeGrad2)"/><circle cx="50" cy="78" r="5" fill="url(#globeGrad2)"/><circle cx="22" cy="50" r="5" fill="url(#globeGrad2)"/><circle cx="78" cy="50" r="5" fill="url(#globeGrad2)"/><circle cx="50" cy="50" r="4" fill="#ffffff"/></svg>';
