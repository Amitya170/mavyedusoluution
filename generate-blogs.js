...
function generateHTML(post) {
  ...
  const LOGO_SVG = `<div class="mavy-4d-coded-wrapper logo-icon" style="width: 2.6em; height: 2.6em;">  <div class="q-tumbler">    <div class="q-layer layer-1"><svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" style="width:100%; height:100%; overflow:visible;">  <defs>    <linearGradient id="qGrad1" x1="0%" y1="0%" x2="100%" y2="100%">      <stop offset="0%" stop-color="#22D3EE" />      <stop offset="50%" stop-color="#C084FC" />      <stop offset="100%" stop-color="#FCD34D" />    </linearGradient>    <linearGradient id="qGrad2" x1="100%" y1="0%" x2="0%" y2="100%">      <stop offset="0%" stop-color="#FCD34D" />      <stop offset="50%" stop-color="#A855F7" />      <stop offset="100%" stop-color="#0284C7" />    </linearGradient>    <radialGradient id="coreGlowRad" cx="50%" cy="50%" r="50%">      <stop offset="0%" stop-color="#C084FC" stop-opacity="0.4" />      <stop offset="100%" stop-color="#000000" stop-opacity="0" />    </radialGradient>    <filter id="qGlowFilter" x="-40%" y="-40%" width="180%" height="180%">      <feGaussianBlur stdDeviation="3" result="blur" />      <feMerge>        <feMergeNode in="blur" />        <feMergeNode in="SourceGraphic" />      </feMerge>    </filter>  </defs>  <circle cx="60" cy="60" r="45" fill="url(#coreGlowRad)" />  <ellipse cx="60" cy="60" rx="52" ry="22" stroke="url(#qGrad1)" stroke-width="2" stroke-dasharray="16 8" class="q-ring-1" filter="url(#qGlowFilter)" />  <ellipse cx="60" cy="60" rx="22" ry="52" stroke="url(#qGrad2)" stroke-width="2" stroke-dasharray="20 10" class="q-ring-2" filter="url(#qGlowFilter)" />  <path d="M 38 38 L 82 38 M 38 60 L 74 60 M 38 82 L 82 82 M 38 38 L 38 82" stroke="url(#qGrad2)" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" opacity="0.8" />  <path d="M 28 82 L 28 38 L 60 68 L 92 38 L 92 82" stroke="url(#qGrad1)" stroke-width="6.5" stroke-linecap="round" stroke-linejoin="round" filter="url(#qGlowFilter)" />  <circle cx="28" cy="38" r="4" fill="#ffffff" filter="url(#qGlowFilter)" />  <circle cx="60" cy="68" r="4" fill="#FCD34D" filter="url(#qGlowFilter)" />  <circle cx="92" cy="38" r="4" fill="#ffffff" filter="url(#qGlowFilter)" />  <circle cx="38" cy="60" r="3.5" fill="#22D3EE" filter="url(#qGlowFilter)" />  <circle cx="74" cy="60" r="3.5" fill="#FCD34D" filter="url(#qGlowFilter)" />  <circle cx="82" cy="38" r="3.5" fill="#22D3EE" filter="url(#qGlowFilter)" />  <circle cx="82" cy="82" r="3.5" fill="#22D3EE" filter="url(#qGlowFilter)" /></svg></div>    <div class="q-layer layer-2"><svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" style="width:100%; height:100%; overflow:visible;">  <defs>    <linearGradient id="qGrad1" x1="0%" y1="0%" x2="100%" y2="100%">      <stop offset="0%" stop-color="#22D3EE" />      <stop offset="50%" stop-color="#C084FC" />      <stop offset="100%" stop-color="#FCD34D" />    </linearGradient>    <linearGradient id="qGrad2" x1="100%" y1="0%" x2="0%" y2="100%">      <stop offset="0%" stop-color="#FCD34D" />      <stop offset="50%" stop-color="#A855F7" />      <stop offset="100%" stop-color="#0284C7" />    </linearGradient>    <radialGradient id="coreGlowRad" cx="50%" cy="50%" r="50%">      <stop offset="0%" stop-color="#C084FC" stop-opacity="0.4" />      <stop offset="100%" stop-color="#000000" stop-opacity="0" />    </radialGradient>    <filter id="qGlowFilter" x="-40%" y="-40%" width="180%" height="180%">      <feGaussianBlur stdDeviation="3" result="blur" />      <feMerge>        <feMergeNode in="blur" />        <feMergeNode in="SourceGraphic" />      </feMerge>    </filter>  </defs>  <circle cx="60" cy="60" r="45" fill="url(#coreGlowRad)" />  <ellipse cx="60" cy="60" rx="52" ry="22" stroke="url(#qGrad1)" stroke-width="2" stroke-dasharray="16 8" class="q-ring-1" filter="url(#qGlowFilter)" />  <ellipse cx="60" cy="60" rx="22" ry="52" stroke="url(#qGrad2)" stroke-width="2" stroke-dasharray="20 10" class="q-ring-2" filter="url(#qGlowFilter)" />  <path d="M 38 38 L 82 38 M 38 60 L 74 60 M 38 82 L 82 82 M 38 38 L 38 82" stroke="url(#qGrad2)" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" opacity="0.8" />  <path d="M 28 82 L 28 38 L 60 68 L 92 38 L 92 82" stroke="url(#qGrad1)" stroke-width="6.5" stroke-linecap="round" stroke-linejoin="round" filter="url(#qGlowFilter)" />  <circle cx="28" cy="38" r="4" fill="#ffffff" filter="url(#qGlowFilter)" />  <circle cx="60" cy="68" r="4" fill="#FCD34D" filter="url(#qGlowFilter)" />  <circle cx="92" cy="38" r="4" fill="#ffffff" filter="url(#qGlowFilter)" />  <circle cx="38" cy="60" r="3.5" fill="#22D3EE" filter="url(#qGlowFilter)" />  <circle cx="74" cy="60" r="3.5" fill="#FCD34D" filter="url(#qGlowFilter)" />  <circle cx="82" cy="38" r="3.5" fill="#22D3EE" filter="url(#qGlowFilter)" />  <circle cx="82" cy="82" r="3.5" fill="#22D3EE" filter="url(#qGlowFilter)" /></svg></div>  </div></div>`;
